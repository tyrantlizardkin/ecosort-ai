...
Look at the image and identify the single most prominent disposable item.
...
- "landfill" → mixed materials, soiled items, styrofoam, plastic film, unknown items, anything not clearly recyclable or compostable

Respond with ONLY a tool call. Confidence is 0-100. Tip should be ONE short actionable sentence (max 12 words).`;
      ...
      body: JSON.stringify({
        ...
        messages: [
          { role: "system", content: SYSTEM_PROMPT },
          {
            role: "user",
            content: [
              { type: "text", text: "Classify this item for disposal." },
        ...
        tools: [
          {
            ...
            function: {
              name: "classify_item",
              description: "Return the disposal classification.",
              parameters: {
                type: "object",
                properties: {
                ...
                required: ["item", "category", "confidence", "tip"],
